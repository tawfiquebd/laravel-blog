    ...
    <div class="row">
        <div class="col-xl-6 col-lg-6 offset-md-3">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{url('/settings/profile/update')}}" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="row">
        <div class="col-xl-6 col-lg-6 offset-md-3">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{url('/settings/update/password')}}" method="POST" enctype="multipart/form-data">
                        @csrf
